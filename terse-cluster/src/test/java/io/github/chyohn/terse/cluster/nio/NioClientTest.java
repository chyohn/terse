...
class NioClientTest {
    ...
    void testC() throws Exception {
        ...
        synchronized (NioClientTest.class) {
            NioClientTest.class.wait();
        }
    }

    void test() throws Exception {
        NIOClient client = new NIOClient(new InetSocketAddress("127.0.0.1", 9001), new ChannelHandler() {
            @Override
            ...
            public void received(Channel channel, Object message) {
                ...
                System.out.println("recevie id: " + ss[0]);
            }
        ...
        new Thread(() -> {
            while (!client.isClosed()) {
                try {
                    ...
                    String t = id + ";;" + genString(random.nextInt(1024 * 1024));
                    String msg = t + ";;;" + t;
